...
- 睡眠処理実装済み（`SleepManager.cs`新規追加。フェードアウト1秒→時刻8時間進める→hpMax/staminaMax+20%ボーナス・STAを新maxに回復→フェードイン1秒）
...
Add as a top-level ## Language section near the top of CLAUDE.md\n\n## Language
...
Add under a new ## Unity Development section\n\n## Unity Development
